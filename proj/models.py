...
class GovernmentProject(MyModel):
    ...
    realname = models.CharField(max_length=128, default='名称', blank=True, null=True)
    contactPerson = models.CharField(help_text='联系人', max_length=64, blank=True, null=True)
    phoneAreaCode = models.CharField(help_text='联系人手机区号', max_length=8, blank=True, null=True)
    phoneNumber = models.CharField(help_text='联系人手机号码', max_length=32, blank=True, null=True)
    email = models.EmailField(help_text='联系人邮箱', max_length=48, db_index=True, blank=True, null=True)
...
class GovernmentProjectIndustry(models.Model):
    ...
    class Meta:
        ...
        unique_together = ('govproj', 'industry')
...
class GovernmentProjectTrader(MyModel):
    ...
    type = models.PositiveSmallIntegerField(blank=True, null=True, help_text='联络人0、对接人1、上传人、发起人、开发团队、执行团队、项目经理')
