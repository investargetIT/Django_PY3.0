...
class ProjectFilter(FilterSet):
    ...
    class Meta:
        model = project
        fields = ('ids', 'bdm', 'indGroup', 'createuser','service','supportUser','isoverseasproject','industries','tags','projstatus','country','netIncome_USD_F','netIncome_USD_T','grossProfit_F','grossProfit_T')
