...
urlpatterns = [
    ...
    url(r'^file/path/$', dataroomfilepath, name='dataroom-filepath'),
    url(r'^user/$', user_dataroom, name='user_dataroom-list',),
    url(r'^user/file/$', user_dataroomFile, name='user_dataroomFile-list',),
    url(r'^user/file/(?P<pk>\d+)/$', user_dataroomFileOne, name='user_dataroomFile',),
    url(r'^user/updatefile/$', userUpdateFiles, name='userUpdateFiles-list',),
    url(r'^user/email/(?P<pk>\d+)/$', userFileUpdateEmail, name='sendUserFileUpdateEmail',),
